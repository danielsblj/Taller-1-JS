...
const limpiarElFormulario = (event) => {
  ...
  for (const hobbie of document.getElementsByClassName('hobbieCB')) {
      hobbie.checked = false;
  }
  document.getElementById('tieneExperiencia').checked = false;
  document.getElementById('femenino').checked=false;
  document.getElementById('masculino').checked=false;
  document.getElementById('contenedorExperiencias').classList.add('invisible');
